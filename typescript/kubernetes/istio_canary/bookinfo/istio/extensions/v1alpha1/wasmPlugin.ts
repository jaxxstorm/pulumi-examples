...
export class WasmPlugin extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: WasmPluginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            inputs["apiVersion"] = "extensions.istio.io/v1alpha1";
            inputs["kind"] = "WasmPlugin";
        ...
        super(WasmPlugin.__pulumiType, name, inputs, opts);
    }
}
...
export interface WasmPluginArgs {
    readonly apiVersion?: pulumi.Input<"extensions.istio.io/v1alpha1">;
    readonly kind?: pulumi.Input<"WasmPlugin">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * Extend the functionality provided by the Istio proxy through WebAssembly filters. See more details at: https://istio.io/docs/reference/config/proxy_extensions/wasm-plugin.html
     */
    readonly spec?: pulumi.Input<inputs.extensions.v1alpha1.WasmPluginSpecArgs>;
