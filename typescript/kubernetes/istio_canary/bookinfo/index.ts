...
const productsvc = productPage.createService("productpage", {port: 9080, namespace: ns.metadata.name })


const gateway = new istio.networking.v1alpha3.Gateway("bookinfo", {
  metadata: {
    namespace: ns.metadata.name,
    name: "bookinfo-gw",
  },
...
const virtualSvc = new istio.networking.v1alpha3.VirtualService("bookinfo", {
  metadata: {
    namespace: ns.metadata.name,
  },
  spec: {
...
const destination = new istio.networking.v1alpha3.DestinationRule("canary", {
  metadata: {
    namespace: ns.metadata.name
  },
  spec: {
