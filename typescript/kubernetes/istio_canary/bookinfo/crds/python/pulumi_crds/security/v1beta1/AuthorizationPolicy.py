...
class AuthorizationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param Any spec: Configuration for access control on workloads. See more details at: https://istio.io/docs/reference/config/security/authorization-policy.html
        """
        if api_version is not None:
            pulumi.set(__self__, "api_version", 'security.istio.io/v1beta1')
        if kind is not None:
            pulumi.set(__self__, "kind", 'AuthorizationPolicy')
...
class AuthorizationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a AuthorizationPolicy resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AuthorizationPolicyArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a AuthorizationPolicy resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["kind"] = 'AuthorizationPolicy'
            __props__.__dict__["metadata"] = metadata
            __props__.__dict__["spec"] = spec
            __props__.__dict__["status"] = status
        super(AuthorizationPolicy, __self__).__init__(
            'kubernetes:security.istio.io/v1beta1:AuthorizationPolicy',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional[Any]]:
        """
        Configuration for access control on workloads. See more details at: https://istio.io/docs/reference/config/security/authorization-policy.html
        """
        return pulumi.get(self, "spec")
