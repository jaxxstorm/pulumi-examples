...
class WasmPluginArgs:
    def __init__(__self__, *,
                 ...
                 spec: Optional[pulumi.Input['WasmPluginSpecArgs']] = None,
                 status: Optional[pulumi.Input[Mapping[str, Any]]] = None):
        """
        The set of arguments for constructing a WasmPlugin resource.
        :param pulumi.Input['WasmPluginSpecArgs'] spec: Extend the functionality provided by the Istio proxy through WebAssembly filters. See more details at: https://istio.io/docs/reference/config/proxy_extensions/wasm-plugin.html
        """
        if api_version is not None:
            pulumi.set(__self__, "api_version", 'extensions.istio.io/v1alpha1')
        if kind is not None:
            pulumi.set(__self__, "kind", 'WasmPlugin')
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input['WasmPluginSpecArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: Optional[pulumi.Input['WasmPluginSpecArgs']]):
...
class WasmPlugin(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['WasmPluginSpecArgs']]] = None,
                 status: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 __props__=None):
        """
        Create a WasmPlugin resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['WasmPluginSpecArgs']] spec: Extend the functionality provided by the Istio proxy through WebAssembly filters. See more details at: https://istio.io/docs/reference/config/proxy_extensions/wasm-plugin.html
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WasmPluginArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a WasmPlugin resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["api_version"] = 'extensions.istio.io/v1alpha1'
            __props__.__dict__["kind"] = 'WasmPlugin'
            __props__.__dict__["metadata"] = metadata
            __props__.__dict__["spec"] = spec
            __props__.__dict__["status"] = status
        super(WasmPlugin, __self__).__init__(
            'kubernetes:extensions.istio.io/v1alpha1:WasmPlugin',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WasmPlugin':
        """
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.WasmPluginSpec']]:
        """
        Extend the functionality provided by the Istio proxy through WebAssembly filters. See more details at: https://istio.io/docs/reference/config/proxy_extensions/wasm-plugin.html
        """
        return pulumi.get(self, "spec")
