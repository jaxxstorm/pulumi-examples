...
class VirtualServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VirtualServiceSpecArgs'] spec: Configuration affecting label/content routing, sni routing, etc. See more details at: https://istio.io/docs/reference/config/networking/virtual-service.html
        """
        if api_version is not None:
            pulumi.set(__self__, "api_version", 'networking.istio.io/v1alpha3')
        if kind is not None:
            pulumi.set(__self__, "kind", 'VirtualService')
...
class VirtualService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['VirtualServiceSpecArgs']] spec: Configuration affecting label/content routing, sni routing, etc. See more details at: https://istio.io/docs/reference/config/networking/virtual-service.html
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["kind"] = 'VirtualService'
            __props__.__dict__["metadata"] = metadata
            __props__.__dict__["spec"] = spec
            __props__.__dict__["status"] = status
        super(VirtualService, __self__).__init__(
            'kubernetes:networking.istio.io/v1alpha3:VirtualService',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.VirtualServiceSpec']]:
        """
        Configuration affecting label/content routing, sni routing, etc. See more details at: https://istio.io/docs/reference/config/networking/virtual-service.html
        """
        return pulumi.get(self, "spec")
