...
class EnvoyFilterSpec(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "configPatches":
            suggest = "config_patches"
        elif key == "workloadSelector":
            suggest = "workload_selector"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in EnvoyFilterSpec. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        EnvoyFilterSpec.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 config_patches: Optional[Sequence['outputs.EnvoyFilterSpecConfigPatches']] = None,
                 priority: Optional[int] = None,
                 workload_selector: Optional['outputs.EnvoyFilterSpecWorkloadSelector'] = None):
        """
        Customizing Envoy configuration generated by Istio. See more details at: https://istio.io/docs/reference/config/networking/envoy-filter.html
        :param Sequence['EnvoyFilterSpecConfigPatchesArgs'] config_patches: One or more patches with match conditions.
        :param int priority: Priority defines the order in which patch sets are applied within a context.
        """
    ...
    def config_patches(self) -> Optional[Sequence['outputs.EnvoyFilterSpecConfigPatches']]:
        """
    ...
    def workload_selector(self) -> Optional['outputs.EnvoyFilterSpecWorkloadSelector']:
        return pulumi.get(self, "workload_selector")


@pulumi.output_type
class EnvoyFilterSpecConfigPatches(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "applyTo":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in EnvoyFilterSpecConfigPatches. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        EnvoyFilterSpecConfigPatches.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 patch: Optional['outputs.EnvoyFilterSpecConfigPatchesPatch'] = None):
        """
        :param Any match: Match on listener/route configuration/cluster.
        :param 'EnvoyFilterSpecConfigPatchesPatchArgs' patch: The patch to apply along with the operation.
        """
    ...
    def apply_to(self) -> Optional[str]:
    ...
    @property
    @pulumi.getter
    def patch(self) -> Optional['outputs.EnvoyFilterSpecConfigPatchesPatch']:
        """
...
@pulumi.output_type
class EnvoyFilterSpecConfigPatchesPatch(dict):
    """
    The patch to apply along with the operation.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in EnvoyFilterSpecConfigPatchesPatch. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        EnvoyFilterSpecConfigPatchesPatch.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        The patch to apply along with the operation.
        :param str filter_class: Determines the filter insertion order.
        :param str operation: Determines how the patch should be applied.
        :param Mapping[str, Any] value: The JSON config of the object being patched.
        """
...
@pulumi.output_type
class EnvoyFilterSpecWorkloadSelector(dict):
    def __init__(__self__, *,
                 labels: Optional[Mapping[str, str]] = None):
        if labels is not None:
            pulumi.set(__self__, "labels", labels)
...
class WorkloadGroupSpec(dict):
    ...
    """
    def __init__(__self__, *,
                 metadata: Optional['outputs.WorkloadGroupSpecMetadata'] = None,
                 probe: Optional[Any] = None,
                 template: Optional['outputs.WorkloadGroupSpecTemplate'] = None):
        """
        Describes a collection of workload instances. See more details at: https://istio.io/docs/reference/config/networking/workload-group.html
        :param 'WorkloadGroupSpecMetadataArgs' metadata: Metadata that will be used for all corresponding `WorkloadEntries`.
        :param Any probe: `ReadinessProbe` describes the configuration the user must provide for healthchecking on their workload.
        :param 'WorkloadGroupSpecTemplateArgs' template: Template to be used for the generation of `WorkloadEntry` resources that belong to this `WorkloadGroup`.
        """
    ...
    @property
    @pulumi.getter
    def metadata(self) -> Optional['outputs.WorkloadGroupSpecMetadata']:
        """
    ...
    @property
    @pulumi.getter
    def template(self) -> Optional['outputs.WorkloadGroupSpecTemplate']:
        """
...
@pulumi.output_type
class WorkloadGroupSpecMetadata(dict):
    """
    Metadata that will be used for all corresponding `WorkloadEntries`.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class WorkloadGroupSpecTemplate(dict):
    """
    Template to be used for the generation of `WorkloadEntry` resources that belong to this `WorkloadGroup`.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in WorkloadGroupSpecTemplate. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        WorkloadGroupSpecTemplate.__key_warning(key)
        return super().__getitem__(key)
