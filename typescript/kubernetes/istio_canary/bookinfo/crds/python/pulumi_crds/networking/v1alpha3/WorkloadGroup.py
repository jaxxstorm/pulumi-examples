...
class WorkloadGroupArgs:
    def __init__(__self__, *,
                 ...
                 spec: Optional[pulumi.Input['WorkloadGroupSpecArgs']] = None,
                 status: Optional[pulumi.Input[Mapping[str, Any]]] = None):
        """
        The set of arguments for constructing a WorkloadGroup resource.
        :param pulumi.Input['WorkloadGroupSpecArgs'] spec: Describes a collection of workload instances. See more details at: https://istio.io/docs/reference/config/networking/workload-group.html
        """
        if api_version is not None:
            pulumi.set(__self__, "api_version", 'networking.istio.io/v1alpha3')
        if kind is not None:
            pulumi.set(__self__, "kind", 'WorkloadGroup')
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input['WorkloadGroupSpecArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: Optional[pulumi.Input['WorkloadGroupSpecArgs']]):
...
class WorkloadGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['WorkloadGroupSpecArgs']]] = None,
                 status: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['WorkloadGroupSpecArgs']] spec: Describes a collection of workload instances. See more details at: https://istio.io/docs/reference/config/networking/workload-group.html
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["kind"] = 'WorkloadGroup'
            __props__.__dict__["metadata"] = metadata
            __props__.__dict__["spec"] = spec
            __props__.__dict__["status"] = status
        super(WorkloadGroup, __self__).__init__(
            'kubernetes:networking.istio.io/v1alpha3:WorkloadGroup',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.WorkloadGroupSpec']]:
        """
        Describes a collection of workload instances. See more details at: https://istio.io/docs/reference/config/networking/workload-group.html
        """
        return pulumi.get(self, "spec")
