...
func NewApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:core.oam.dev/v1alpha2:Application", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplication(ctx *pulumi.Context,
	...
	var resource Application
	err := ctx.ReadResource("kubernetes:core.oam.dev/v1alpha2:Application", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
